  ...
  return (
    <div id="home">
      ...
      <div className="home-text">
        ...
        <p>If you're hungry, click on <b>Find a Meal</b> above to discover the best versions of what you're craving.</p>
        <p>Trying something new? Click on <b>Create Review</b> to give the community your thoughts on a particular dish.</p>
      </div>
    </div>
  )
}
